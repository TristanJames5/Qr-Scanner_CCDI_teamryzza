...
const QR_HMAC_SECRET = process.env.QR_HMAC_SECRET; // guaranteed by validateEnv.js at startup
...
// SECURITY: Uses crypto.randomInt — cryptographically secure. Math.random() is NOT safe here.
...
export function verifyQRToken(rawToken, targetSessionId) {
  try {
    ...
    // SECURITY: timingSafeEqual prevents timing-based signature oracle attacks
    // Standard: OWASP — compare MACs in constant time
