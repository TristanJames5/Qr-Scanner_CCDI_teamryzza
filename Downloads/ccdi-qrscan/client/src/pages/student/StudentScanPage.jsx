...
export const StudentScanPage = () => {
  ...
  const handleProcessScan = async (payload) => {
    try {
      ...
      // S-Class: Geo-Fence Validation
      // We must get the student's GPS coordinates before sending the scan to the server
      try {
        ...
        setScanError('Location required: Please enable GPS/Location Services to verify you are on campus.');
        setSubmitting(false);
