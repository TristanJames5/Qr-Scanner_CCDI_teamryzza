      ...
      <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 via-blue-950/40 to-slate-900 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2.5 px-5 py-3.5 rounded-2xl text-xs font-bold text-blue-200 bg-blue-950/60 hover:bg-blue-900/70 border border-blue-600/50 shadow-lg shadow-blue-950/40 transition-all group"
          >
